...
\begin{verbatim}
##           [,1]   [,2]  [,3]    [,4]    [,5]  [,6]
## result.1 1.006 -2.004 2.994  0.9836 -4.2720 1.638
## result.2 1.004 -2.001 2.999  0.7435 -0.3236 4.307
## result.3 1.001 -2.001 3.005 -1.0458 -0.6022 3.218
\end{verbatim}
...
\begin{verbatim}
##            [,1]   [,2]  [,3]  [,4]   [,5]   [,6]
## result.1 1.0100 -2.001 2.999 2.518 -2.787 0.2465
## result.2 1.0044 -1.994 3.000 1.307 -1.683 3.2326
## result.3 0.9929 -1.999 3.002 1.728 -2.453 3.6329
\end{verbatim}
...
\begin{verbatim}
##           [,1]   [,2]  [,3]    [,4]    [,5]   [,6]
## result.1 1.002 -1.998 3.006 -2.8564 -2.5296  4.281
## result.2 1.001 -1.994 2.999  0.4783 -0.8851  2.513
## result.3 1.004 -1.999 2.999  2.5712 -1.6674 -0.418
\end{verbatim}
...
\begin{verbatim}
##           [,1]   [,2]  [,3]  [,4]    [,5]  [,6]
## result.1 1.003 -1.994 2.997 7.395 -10.601 3.527
## result.2 1.004 -2.005 2.994 1.999  -1.906 3.459
## result.3 1.000 -1.999 2.996 2.890  -3.343 4.518
\end{verbatim}
...
\begin{verbatim}
##            [,1]   [,2]  [,3]   [,4]    [,5]   [,6]
## result.1 0.9966 -1.996 3.009 12.941 -1.3502  8.478
## result.2 1.0006 -2.000 3.002 -1.841  0.5314  4.222
## result.3 1.0043 -1.999 2.998  4.110 -8.8642 20.321
\end{verbatim}
