...
\begin{verbatim}
##            [,1]   [,2]  [,3]    [,4]   [,5]  [,6]
## result.1 1.0041 -2.002 3.003  1.0672 -3.296 2.988
## result.2 1.0004 -2.003 3.000  0.7639 -4.966 4.515
## result.3 0.9998 -2.003 3.002 -2.0400 -5.193 3.312
\end{verbatim}
...
\begin{verbatim}
##            [,1]   [,2]  [,3]   [,4]   [,5]  [,6]
## result.1 1.0075 -1.998 3.002 0.5562 -3.824 4.650
## result.2 1.0068 -2.005 2.999 2.4827 -1.803 2.670
## result.3 0.9984 -1.998 2.996 3.1243 -1.106 4.368
\end{verbatim}

可以看到,执行时间相差并不多.当我们延长单次模拟的时间
...
\begin{verbatim}
##            [,1]   [,2]  [,3]   [,4]   [,5]    [,6]
## result.1 1.0044 -1.992 3.003  1.357 -2.021  4.7087
## result.2 0.9971 -2.002 2.997 -2.295 -3.333 10.9902
## result.3 0.9990 -1.999 2.998  3.591 -4.287 -0.1508
\end{verbatim}
